...
module.exports = function makeErrorSenders(grantTypes) {
    ...
    return {
        ...
        authenticationRequired: function (res, next, options, message) {
            ...
            sendAuthenticationRequired(res, next, options, new errors.UnauthorizedError(message));
        },
        ...
        insufficientAuthorization: function (res, next, options, message) {
            ...
            sendInsufficientAuthorization(res, next, options, new errors.ForbiddenError(message));
        },
        ...
        tokenInvalid: function (res, next, options, message) {
            ...
            sendWithHeaders(res, next, options, new errors.UnauthorizedError(message));
        }
    };
};
